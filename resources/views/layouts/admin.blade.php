...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard - Wapen')</title>
...
<body class="bg-surface font-body-md text-on-surface flex min-h-screen">
    ...
    @endphp
    @include('admin.partials.sidebar', ['active' => $activeMenu])
    ...
    <main class="flex-1 ml-0 md:ml-64 bg-background min-h-screen">
        <header
            ...
            <div class="flex items-center gap-4">
                ...
                <h1 class="font-headline-md text-headline-md text-on-surface">@yield('page_title', 'Dashboard Admin')</h1>
            </div>
